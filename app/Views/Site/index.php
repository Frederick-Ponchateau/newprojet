        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-purple-deep-orange gradient-shadow">
            <div class="nav-wrapper">
                <div class="header-search-wrapper hide-on-med-and-down"><i class="material-icons">search</i>
                    <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Recherche" data-search="template-list">
                ...
                <div class="nav-wrapper">
                    <form id="navbarForm" >
                        <div class="input-field search-input-sm">
                            <input class="search-box-sm mb-0" type="search" name='search' required="" id="search" placeholder="Recherche" data-search="template-list">
...
<div id="main">
    <div class="row">
    <div class="content-wrapper-before gradient-45deg-purple-deep-orange gradient-shadow"></div>
                ...
                <div class="row ">
                    <div class="col s10 m6 l6 breadcrumbs-left">
                        ...
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item active">films
                            </li>
                        </ol>
                    </div>
            ...
            <div class="container">
                <!--Gradient Card-->
                    ...
                    <div id="card-panel-type" class="section">
                      <h4 class="header"> Films</h4>
                      <div class="row mt-2">
                      <?php if(isset($tableFilm)):
                        foreach($tableFilm as $film):
